...
export const Aboutdata = [
    "Accurately account for every second, gaining a clear understanding of your work patterns.", "Foster transparent communication with clients and team members, creating a collaborative environment that drives success.", "With offline support and auto-sync, Traverse adapts to your work style, allowing seamless time tracking regardless of your location."
]
