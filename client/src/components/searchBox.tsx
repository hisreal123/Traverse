  ...
  return (
    <>
      <button
        ...
        className={cn(
          " transition-opacity duration-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-light  min-[600px]:hidden border border-soft-light dark:border-success/20  flex justify-center items-center rounded-sm h-[30px] w-full max-w-[30px]"
        )}
      >
      ...
      <div className="hidden min-[600px]:flex w-full max-w-[349px] lg:w-[349px] h-[48px] relative items-center">
        <div className=" items-center w-full h-full relative flex">
          ...
          <Search
            size={18}
            className="absolute left-3 text-light dark:text-white "
            aria-hidden
            tabIndex={-1}
          />
        </div>
        ...
        >
          <X size={18} className="text-white dark:text-white " />
        </button>
      </div>
    </>
  );
