...
import DropdownButton from "../miscellaneous/dropdown";
...
const UserContainer = () => {
  ...
  return (
    <div
      role="button"
      className="w-full max-w-[50px] lg:max-w-[215px] h-[52px] flex items-center gap-x-1 justify-center lg:justify-between p-1 lg:px-2 lg:py-[6px] relative "
    >
      <button
        type="button"
        aria-haspopup
